          ...
          <div className="row">
            ...
            <div className="col-6 col-lg-4 mb-3">
              ...
              <ul className="list-unstyled">
                ...
                <li className="mb-2"><a href="/docs/5.0/">Centro de ayuda</a></li>
              </ul>
            </div>
            <div className="col-6 col-lg-4 mb-3">
              <h5>Cuenta</h5>
              <ul className="list-unstyled">
                <li className="mb-2"><a href="/docs/5.0/getting-started/">Mi cuenta</a></li>
                <li className="mb-2"><a href="/docs/5.0/examples/starter-template/">Historial de compras</a></li>
                <li className="mb-2"><a href="/docs/5.0/getting-started/webpack/">Contactanos</a></li>
                <li className="mb-2"><a href="/docs/5.0/getting-started/parcel/">Ver Boleta</a></li>
              </ul>
            </div>
          </div>
        </div>
